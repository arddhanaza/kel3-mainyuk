...
public class gambarLima extends AppCompatActivity {
      ...
      protected void onCreate(Bundle savedInstanceState) {
            ...
            findViewById(R.id.iButtonPilihanA).setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View v) {
                        AlertDialog.Builder AlertBox = new AlertDialog.Builder(gambarLima.this, android.R.style.Theme_Holo_Light_Dialog_NoActionBar_MinWidth);
