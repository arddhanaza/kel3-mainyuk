...
public class suaraEnamActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_suara_enam);

        ImageView play = (ImageView) findViewById(R.id.play);

        final MediaPlayer mp = MediaPlayer.create(suaraEnamActivity.this, R.raw.anjing);
        ...
        findViewById(R.id.iButtonPilihanC).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder AlertBox = new AlertDialog.Builder(suaraEnamActivity.this, android.R.style.Theme_Holo_Light_Dialog_NoActionBar_MinWidth);
